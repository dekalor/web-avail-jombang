...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert('product_units', [
      ...
      { product_id: productMap.get('Avail FC Pantiliner'), unit_code: 'ball', label: 'BALL', price: 330000, weight: 500, qty_per_unit: 10 },
      { product_id: productMap.get('Avail FC Night Use'), unit_code: 'pcs', label: 'PCS', price: 42500, weight: 50, qty_per_unit: 1 },
      ...
      { product_id: productMap.get('Avail FC Kombinasi'), unit_code: 'ball', label: 'BALL', price: 366750, weight: 600, qty_per_unit: 1 },
